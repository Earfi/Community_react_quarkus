            ...
            <div className='h-full w-full overflow-y-auto bg-white flex flex-col gap-5 p-3 sm:p-10 mx-auto'>
                <div className="flex flex-wrap justify-center items-start w-full h-full p-2">
                    ...
                    <div className='w-full sm:w-[600px] flex flex-col justify-center items-start sm:items-start gap-2'>
                        <div className="w-full h-[300px] sm:w-full mb-2 bg-white object-contain relative">
                    ...
                    <div className="w-[600px] border min-h-[300px] p-5 mb-2">
                        ...
                        <p className="my-2 overflow-hidden text-xs sm:text-sm">{product.descriptions}</p>
                        <p className="text-sm">
