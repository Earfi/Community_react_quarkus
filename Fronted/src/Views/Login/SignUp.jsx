                ...
                <div className="w-full max-w-xl mx-auto p-6 bg-white rounded-md shadow-md">
                    ...
                    <form onSubmit={handleSubmit} className='mt-5'>
                        <div onClick={() => handleImageClick} className='w-full flex flex-col justify-center'> 
                            {profile ? <img className="w-[200px] h-[200px] object-cover mx-auto border-4 border-black rounded-full" src={URL.createObjectURL(profile)} alt="" />  : <img className="w-[200px] h-[200px] object-cover mx-auto border-4 border-black rounded-full" src={profile|| "../../../public/img/profile//profile-icon.png"} alt="" /> }
